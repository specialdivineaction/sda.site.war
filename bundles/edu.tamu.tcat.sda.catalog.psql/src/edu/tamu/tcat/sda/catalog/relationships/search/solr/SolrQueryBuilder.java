...
public class SolrQueryBuilder
{
   ...
   public static class Builder
   {
      ...
      /**
       * Sets the maximum number of documents to be returned. If this is undefined, the default is set to 10.
       * @param rows
       */
       ...
       */
      public Builder addFacetFields(String[] fieldNames, Integer minCount)
      {
         builderQuery.setFacet(true);
         builderQuery.setFacetMinCount(minCount > 1 ? minCount : 1);
         builderQuery.addFacetField(fieldNames);
         return this;
      }
       ...
       * @param fieldNames - Determines which field(s) a facet should be calculated upon.
       */
      public Builder addFacetFields(String[] fieldNames)
      {
         int minCount = 1;
